...
class OrderDetailsControllerTest < ActionController::TestCase
  ...
  test "should create order_detail" do
    assert_difference('OrderDetail.count') do
      post :create, order_detail: { amount: @order_detail.amount, order_id: @order_detail.order_id, product_id: @order_detail.product_id }
    end
  ...
  test "should update order_detail" do
    patch :update, id: @order_detail, order_detail: { amount: @order_detail.amount, order_id: @order_detail.order_id, product_id: @order_detail.product_id }
    assert_redirected_to order_detail_path(assigns(:order_detail))
  end
